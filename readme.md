...
python ./opt_v3/keypoints_convert.py --video-url ./videos/new/37.mp4 --unsorted-json ./miner_responses_no_ordered/37.json
python keypoints_calculate_score.py --video-url ./videos/new/37.mp4 --miner-json ./miner_responses_ordered_optimised/37.json --verbose
